...
export const globalComponentsConfig: GlobalComponentConfig[] = [
  {
    name: '设置面板',
    key: 'settings-panel',
    component: defineAsyncComponent(() => import('@/components/layout/settings-panel/index.vue')),
    enabled: true,
  },
  {
    name: '全局搜索',
    key: 'global-search',
    component: defineAsyncComponent(() => import('@/components/layout/global-search/index.vue')),
    enabled: true,
  },
]
